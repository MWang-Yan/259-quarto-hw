...
- age_group (a categorical age variable with levels: ".5-1 y" "1-1.5 y" "1.5-2 y" "2-4 y" "4-6 y" "8-10 y" "adult" 
...
In the final, merged data, make the "watched" variable is coded as a factor with levels "seen" (1), "not seen" (2), "not sure" (3) .
